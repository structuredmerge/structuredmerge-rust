...
#[test]
fn conforms_to_slice_930_delete_node_edit_projection_contract_fixture() {
    let fixture = read_fixture_from_path(fixture_path(&[
        "diagnostics",
...
#[test]
fn conforms_to_slice_933_go_parser_insert_child_edit_projection_contract_fixture() {
    let fixture = read_fixture_from_path(fixture_path(&[
        "diagnostics",
...
#[test]
fn conforms_to_slice_934_go_parser_delete_node_edit_projection_contract_fixture() {
    let fixture = read_fixture_from_path(fixture_path(&[
        "diagnostics",
