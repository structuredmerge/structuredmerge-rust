...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct NativeProviderProvingGroundReport {
    pub report_id: String,
    pub version: String,
    pub language: String,
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct StructuredEditTargetMatch {
    pub start_boundary: String,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub start_boundary_family: Option<String>,
    pub known_start_boundary: bool,
...
pub struct StructuredEditRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub target_match: Option<StructuredEditTargetMatch>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct StructuredEditProviderExecutionReceiptReplayWorkflowResultEnvelope {
    pub kind: String,
    pub version: u32,
    pub receipt_replay_workflow_result: StructuredEditProviderExecutionReceiptReplayWorkflowResult,
}

#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct StructuredEditProviderBatchExecutionReceiptReplayWorkflowResult {
    pub receipt_replay_workflow_results:
        Vec<StructuredEditProviderExecutionReceiptReplayWorkflowResult>,
    #[serde(default)]
    pub metadata: HashMap<String, serde_json::Value>,
}

#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct StructuredEditProviderExecutionReceiptReplayWorkflowReviewRequest {
    pub receipt_replay_workflow_result: StructuredEditProviderExecutionReceiptReplayWorkflowResult,
    #[serde(default)]
    pub metadata: HashMap<String, serde_json::Value>,
}
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct StructuredEditProviderExecutionReceiptReplayWorkflowApplyRequest {
    pub receipt_replay_workflow_review_request:
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct StructuredEditProviderExecutionReceiptReplayWorkflowApplyResult {
    pub receipt_replay_workflow_apply_session:
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct StructuredEditProviderExecutionReceiptReplayWorkflowApplyDecision {
    pub receipt_replay_workflow_apply_result:
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct StructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionOutcome {
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct StructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionSettlement {
    pub receipt_replay_workflow_apply_decision_outcome:
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct StructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionClosureReport {
    pub receipt_replay_workflow_apply_decision_confirmation:
        StructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionConfirmation,
    pub closure_report: String,
    #[serde(default)]
    pub metadata: HashMap<String, serde_json::Value>,
}

#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct StructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionAuditRecord {
    pub receipt_replay_workflow_apply_decision_closure_report:
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct StructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionOutcomeEnvelope {
    pub kind: String,
    pub version: u32,
    pub receipt_replay_workflow_apply_decision_outcome:
        StructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionOutcome,
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct StructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionConfirmationEnvelope {
    pub kind: String,
    pub version: u32,
    pub receipt_replay_workflow_apply_decision_confirmation:
        StructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionConfirmation,
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct StructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionClosureReportEnvelope {
    pub kind: String,
    pub version: u32,
    pub receipt_replay_workflow_apply_decision_closure_report:
        StructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionClosureReport,
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct StructuredEditProviderExecutionReceiptReplayWorkflowReviewRequestEnvelope {
    pub kind: String,
    pub version: u32,
    pub receipt_replay_workflow_review_request:
        StructuredEditProviderExecutionReceiptReplayWorkflowReviewRequest,
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyRequest {
    pub apply_requests: Vec<StructuredEditProviderExecutionReceiptReplayWorkflowApplyRequest>,
    #[serde(default)]
    pub metadata: HashMap<String, serde_json::Value>,
}

#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplySession {
    pub apply_sessions: Vec<StructuredEditProviderExecutionReceiptReplayWorkflowApplySession>,
    #[serde(default)]
    pub metadata: HashMap<String, serde_json::Value>,
}

#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyResult {
    pub apply_results: Vec<StructuredEditProviderExecutionReceiptReplayWorkflowApplyResult>,
    #[serde(default)]
    pub metadata: HashMap<String, serde_json::Value>,
}
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionOutcome {
    pub apply_decision_outcomes:
        Vec<StructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionOutcome>,
    #[serde(default)]
    pub metadata: HashMap<String, serde_json::Value>,
}

#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionSettlement {
    pub apply_decision_settlements:
        Vec<StructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionSettlement>,
    #[serde(default)]
    pub metadata: HashMap<String, serde_json::Value>,
}

#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionConfirmation {
    pub apply_decision_confirmations:
        Vec<StructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionConfirmation>,
    #[serde(default)]
    pub metadata: HashMap<String, serde_json::Value>,
}

#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionClosureReport {
    pub closure_reports:
        Vec<StructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionClosureReport>,
    #[serde(default)]
    pub metadata: HashMap<String, serde_json::Value>,
}
...
pub struct StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyRequestEnvelope {
    pub kind: String,
    pub version: u32,
    pub batch_receipt_replay_workflow_apply_request:
        StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyRequest,
}

#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplySessionEnvelope {
    pub kind: String,
    pub version: u32,
    pub batch_receipt_replay_workflow_apply_session:
        StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplySession,
}

#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyResultEnvelope {
    pub kind: String,
    pub version: u32,
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionSettlementEnvelope
{
    pub kind: String,
    pub version: u32,
    pub batch_receipt_replay_workflow_apply_decision_settlement:
        StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionSettlement,
}

#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionConfirmationEnvelope
{
    pub kind: String,
    pub version: u32,
    pub batch_receipt_replay_workflow_apply_decision_confirmation:
        StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionConfirmation,
}

#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionClosureReportEnvelope
{
    pub kind: String,
    pub version: u32,
    pub batch_receipt_replay_workflow_apply_decision_closure_report:
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionOutcomeEnvelope {
    pub kind: String,
    pub version: u32,
    pub batch_receipt_replay_workflow_apply_decision_outcome:
...
pub struct StructuredEditProviderBatchExecutionReceiptReplayWorkflowResultEnvelope {
    pub kind: String,
    pub version: u32,
    pub batch_receipt_replay_workflow_result:
...
pub fn structured_edit_provider_execution_receipt_replay_workflow_result_envelope(
    ...
    StructuredEditProviderExecutionReceiptReplayWorkflowResultEnvelope {
        kind: "structured_edit_provider_execution_receipt_replay_workflow_result".to_string(),
        version: STRUCTURED_EDIT_TRANSPORT_VERSION,
        receipt_replay_workflow_result: receipt_replay_workflow_result.clone(),
    }
}

pub fn import_structured_edit_provider_execution_receipt_replay_workflow_result_envelope(
...
> {
    ...
    if envelope.version != STRUCTURED_EDIT_TRANSPORT_VERSION {
        return Err(StructuredEditTransportImportError {
            category: StructuredEditTransportImportErrorCategory::UnsupportedVersion,
            message: format!(
                "unsupported structured_edit_provider_execution_receipt_replay_workflow_result envelope version {}.",
                envelope.version
            ),
        });
    }

    Ok(envelope.receipt_replay_workflow_result.clone())
}

pub fn structured_edit_provider_batch_execution_receipt_replay_workflow_result_envelope(
    ...
    StructuredEditProviderBatchExecutionReceiptReplayWorkflowResultEnvelope {
        kind: "structured_edit_provider_batch_execution_receipt_replay_workflow_result".to_string(),
        version: STRUCTURED_EDIT_TRANSPORT_VERSION,
        batch_receipt_replay_workflow_result: batch_receipt_replay_workflow_result.clone(),
    }
}

pub fn import_structured_edit_provider_batch_execution_receipt_replay_workflow_result_envelope(
...
> {
    ...
    if envelope.version != STRUCTURED_EDIT_TRANSPORT_VERSION {
        return Err(StructuredEditTransportImportError {
            category: StructuredEditTransportImportErrorCategory::UnsupportedVersion,
            message: format!(
                "unsupported structured_edit_provider_batch_execution_receipt_replay_workflow_result envelope version {}.",
                envelope.version
            ),
        });
    }

    Ok(envelope.batch_receipt_replay_workflow_result.clone())
}

pub fn structured_edit_provider_execution_receipt_replay_workflow_review_request_envelope(
    ...
    StructuredEditProviderExecutionReceiptReplayWorkflowReviewRequestEnvelope {
        kind: "structured_edit_provider_execution_receipt_replay_workflow_review_request"
            .to_string(),
        version: STRUCTURED_EDIT_TRANSPORT_VERSION,
        receipt_replay_workflow_review_request: receipt_replay_workflow_review_request.clone(),
    }
}

pub fn import_structured_edit_provider_execution_receipt_replay_workflow_review_request_envelope(
...
> {
    ...
    if envelope.version != STRUCTURED_EDIT_TRANSPORT_VERSION {
        return Err(StructuredEditTransportImportError {
            category: StructuredEditTransportImportErrorCategory::UnsupportedVersion,
            message: format!(
                "unsupported structured_edit_provider_execution_receipt_replay_workflow_review_request envelope version {}.",
                envelope.version
            ),
        });
    }
...
pub fn structured_edit_provider_execution_receipt_replay_workflow_apply_request_envelope(
    ...
    StructuredEditProviderExecutionReceiptReplayWorkflowApplyRequestEnvelope {
        kind: "structured_edit_provider_execution_receipt_replay_workflow_apply_request"
            .to_string(),
        version: STRUCTURED_EDIT_TRANSPORT_VERSION,
        receipt_replay_workflow_apply_request: receipt_replay_workflow_apply_request.clone(),
    }
}

pub fn import_structured_edit_provider_execution_receipt_replay_workflow_apply_request_envelope(
...
> {
    ...
    if envelope.version != STRUCTURED_EDIT_TRANSPORT_VERSION {
        return Err(StructuredEditTransportImportError {
            category: StructuredEditTransportImportErrorCategory::UnsupportedVersion,
            message: format!(
                "unsupported structured_edit_provider_execution_receipt_replay_workflow_apply_request envelope version {}.",
                envelope.version
            ),
        });
    }

    Ok(envelope.receipt_replay_workflow_apply_request.clone())
}

pub fn structured_edit_provider_execution_receipt_replay_workflow_apply_session_envelope(
    ...
    StructuredEditProviderExecutionReceiptReplayWorkflowApplySessionEnvelope {
        kind: "structured_edit_provider_execution_receipt_replay_workflow_apply_session"
            .to_string(),
        version: STRUCTURED_EDIT_TRANSPORT_VERSION,
        receipt_replay_workflow_apply_session: receipt_replay_workflow_apply_session.clone(),
    }
}

pub fn import_structured_edit_provider_execution_receipt_replay_workflow_apply_session_envelope(
...
> {
    ...
    if envelope.version != STRUCTURED_EDIT_TRANSPORT_VERSION {
        return Err(StructuredEditTransportImportError {
            category: StructuredEditTransportImportErrorCategory::UnsupportedVersion,
            message: format!(
                "unsupported structured_edit_provider_execution_receipt_replay_workflow_apply_session envelope version {}.",
                envelope.version
            ),
        });
    }

    Ok(envelope.receipt_replay_workflow_apply_session.clone())
}

pub fn structured_edit_provider_execution_receipt_replay_workflow_apply_result_envelope(
    ...
    StructuredEditProviderExecutionReceiptReplayWorkflowApplyResultEnvelope {
        kind: "structured_edit_provider_execution_receipt_replay_workflow_apply_result".to_string(),
        version: STRUCTURED_EDIT_TRANSPORT_VERSION,
        receipt_replay_workflow_apply_result: receipt_replay_workflow_apply_result.clone(),
    }
}

pub fn import_structured_edit_provider_execution_receipt_replay_workflow_apply_result_envelope(
...
> {
    ...
    if envelope.version != STRUCTURED_EDIT_TRANSPORT_VERSION {
        return Err(StructuredEditTransportImportError {
            category: StructuredEditTransportImportErrorCategory::UnsupportedVersion,
            message: format!(
                "unsupported structured_edit_provider_execution_receipt_replay_workflow_apply_result envelope version {}.",
                envelope.version
            ),
        });
    }
...
pub fn structured_edit_provider_execution_receipt_replay_workflow_apply_decision_outcome_envelope(
    ...
    StructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionOutcomeEnvelope {
        ...
        receipt_replay_workflow_apply_decision_outcome:
            receipt_replay_workflow_apply_decision_outcome.clone(),
    }
}

pub fn import_structured_edit_provider_execution_receipt_replay_workflow_apply_decision_outcome_envelope(
...
> {
    ...
    if envelope.version != STRUCTURED_EDIT_TRANSPORT_VERSION {
        return Err(StructuredEditTransportImportError {
            category: StructuredEditTransportImportErrorCategory::UnsupportedVersion,
            message: format!(
                "unsupported structured_edit_provider_execution_receipt_replay_workflow_apply_decision_outcome envelope version {}.",
                envelope.version
            ),
        });
    }
...
pub fn structured_edit_provider_execution_receipt_replay_workflow_apply_decision_confirmation_envelope(
    ...
    StructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionConfirmationEnvelope {
        ...
        receipt_replay_workflow_apply_decision_confirmation:
            receipt_replay_workflow_apply_decision_confirmation.clone(),
    }
}

pub fn import_structured_edit_provider_execution_receipt_replay_workflow_apply_decision_confirmation_envelope(
...
> {
    ...
    if envelope.version != STRUCTURED_EDIT_TRANSPORT_VERSION {
        return Err(StructuredEditTransportImportError {
            category: StructuredEditTransportImportErrorCategory::UnsupportedVersion,
            message: format!(
                "unsupported structured_edit_provider_execution_receipt_replay_workflow_apply_decision_confirmation envelope version {}.",
                envelope.version
            ),
        });
    }

    Ok(envelope.receipt_replay_workflow_apply_decision_confirmation.clone())
}

pub fn structured_edit_provider_execution_receipt_replay_workflow_apply_decision_closure_report_envelope(
    ...
    StructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionClosureReportEnvelope {
        ...
        receipt_replay_workflow_apply_decision_closure_report:
            receipt_replay_workflow_apply_decision_closure_report.clone(),
    }
}

pub fn import_structured_edit_provider_execution_receipt_replay_workflow_apply_decision_closure_report_envelope(
...
> {
    ...
    if envelope.version != STRUCTURED_EDIT_TRANSPORT_VERSION {
        return Err(StructuredEditTransportImportError {
            category: StructuredEditTransportImportErrorCategory::UnsupportedVersion,
            message: format!(
                "unsupported structured_edit_provider_execution_receipt_replay_workflow_apply_decision_closure_report envelope version {}.",
                envelope.version
            ),
        });
    }

    Ok(envelope.receipt_replay_workflow_apply_decision_closure_report.clone())
}

pub fn structured_edit_provider_batch_execution_receipt_replay_workflow_apply_decision_settlement_envelope(
    ...
    StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionSettlementEnvelope {
        ...
        batch_receipt_replay_workflow_apply_decision_settlement:
            batch_receipt_replay_workflow_apply_decision_settlement.clone(),
    }
}

pub fn import_structured_edit_provider_batch_execution_receipt_replay_workflow_apply_decision_settlement_envelope(
...
> {
    ...
    if envelope.version != STRUCTURED_EDIT_TRANSPORT_VERSION {
        return Err(StructuredEditTransportImportError {
            category: StructuredEditTransportImportErrorCategory::UnsupportedVersion,
            message: format!(
                "unsupported structured_edit_provider_batch_execution_receipt_replay_workflow_apply_decision_settlement envelope version {}.",
                envelope.version
            ),
        });
    }

    Ok(envelope.batch_receipt_replay_workflow_apply_decision_settlement.clone())
}

pub fn structured_edit_provider_batch_execution_receipt_replay_workflow_apply_decision_confirmation_envelope(
    ...
    StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionConfirmationEnvelope {
        ...
        batch_receipt_replay_workflow_apply_decision_confirmation:
            batch_receipt_replay_workflow_apply_decision_confirmation.clone(),
    }
}

pub fn import_structured_edit_provider_batch_execution_receipt_replay_workflow_apply_decision_confirmation_envelope(
...
> {
    ...
    if envelope.version != STRUCTURED_EDIT_TRANSPORT_VERSION {
        return Err(StructuredEditTransportImportError {
            category: StructuredEditTransportImportErrorCategory::UnsupportedVersion,
            message: format!(
                "unsupported structured_edit_provider_batch_execution_receipt_replay_workflow_apply_decision_confirmation envelope version {}.",
                envelope.version
            ),
        });
    }

    Ok(envelope.batch_receipt_replay_workflow_apply_decision_confirmation.clone())
}

pub fn structured_edit_provider_batch_execution_receipt_replay_workflow_apply_decision_closure_report_envelope(
    ...
    StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionClosureReportEnvelope {
        ...
        batch_receipt_replay_workflow_apply_decision_closure_report:
            batch_receipt_replay_workflow_apply_decision_closure_report.clone(),
    }
}

pub fn import_structured_edit_provider_batch_execution_receipt_replay_workflow_apply_decision_closure_report_envelope(
...
> {
    ...
    if envelope.version != STRUCTURED_EDIT_TRANSPORT_VERSION {
        return Err(StructuredEditTransportImportError {
            category: StructuredEditTransportImportErrorCategory::UnsupportedVersion,
            message: format!(
                "unsupported structured_edit_provider_batch_execution_receipt_replay_workflow_apply_decision_closure_report envelope version {}.",
                envelope.version
            ),
        });
    }

    Ok(envelope.batch_receipt_replay_workflow_apply_decision_closure_report.clone())
}
...
pub fn structured_edit_provider_batch_execution_receipt_replay_workflow_apply_request_envelope(
    ...
    StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyRequestEnvelope {
        kind: "structured_edit_provider_batch_execution_receipt_replay_workflow_apply_request"
            .to_string(),
        version: STRUCTURED_EDIT_TRANSPORT_VERSION,
        batch_receipt_replay_workflow_apply_request: batch_receipt_replay_workflow_apply_request
            .clone(),
    }
}

pub fn import_structured_edit_provider_batch_execution_receipt_replay_workflow_apply_request_envelope(
...
> {
    ...
    if envelope.version != STRUCTURED_EDIT_TRANSPORT_VERSION {
        return Err(StructuredEditTransportImportError {
            category: StructuredEditTransportImportErrorCategory::UnsupportedVersion,
            message: format!(
                "unsupported structured_edit_provider_batch_execution_receipt_replay_workflow_apply_request envelope version {}.",
                envelope.version
            ),
        });
    }

    Ok(envelope.batch_receipt_replay_workflow_apply_request.clone())
}

pub fn structured_edit_provider_batch_execution_receipt_replay_workflow_apply_session_envelope(
    ...
    StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplySessionEnvelope {
        kind: "structured_edit_provider_batch_execution_receipt_replay_workflow_apply_session"
            .to_string(),
        version: STRUCTURED_EDIT_TRANSPORT_VERSION,
        batch_receipt_replay_workflow_apply_session: batch_receipt_replay_workflow_apply_session
            .clone(),
    }
}

pub fn import_structured_edit_provider_batch_execution_receipt_replay_workflow_apply_session_envelope(
...
> {
    ...
    if envelope.version != STRUCTURED_EDIT_TRANSPORT_VERSION {
        return Err(StructuredEditTransportImportError {
            category: StructuredEditTransportImportErrorCategory::UnsupportedVersion,
            message: format!(
                "unsupported structured_edit_provider_batch_execution_receipt_replay_workflow_apply_session envelope version {}.",
                envelope.version
            ),
        });
    }

    Ok(envelope.batch_receipt_replay_workflow_apply_session.clone())
}

pub fn structured_edit_provider_batch_execution_receipt_replay_workflow_apply_result_envelope(
    ...
    StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyResultEnvelope {
        kind: "structured_edit_provider_batch_execution_receipt_replay_workflow_apply_result"
            .to_string(),
        version: STRUCTURED_EDIT_TRANSPORT_VERSION,
        batch_receipt_replay_workflow_apply_result: batch_receipt_replay_workflow_apply_result
            .clone(),
    }
}

pub fn import_structured_edit_provider_batch_execution_receipt_replay_workflow_apply_result_envelope(
...
> {
    ...
    if envelope.version != STRUCTURED_EDIT_TRANSPORT_VERSION {
        return Err(StructuredEditTransportImportError {
            category: StructuredEditTransportImportErrorCategory::UnsupportedVersion,
            message: format!(
                "unsupported structured_edit_provider_batch_execution_receipt_replay_workflow_apply_result envelope version {}.",
                envelope.version
            ),
        });
    }
...
pub fn structured_edit_provider_batch_execution_receipt_replay_workflow_apply_decision_outcome_envelope(
    ...
    StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionOutcomeEnvelope {
        ...
        batch_receipt_replay_workflow_apply_decision_outcome:
            batch_receipt_replay_workflow_apply_decision_outcome.clone(),
    }
}

pub fn import_structured_edit_provider_batch_execution_receipt_replay_workflow_apply_decision_outcome_envelope(
...
> {
    ...
    if envelope.version != STRUCTURED_EDIT_TRANSPORT_VERSION {
        return Err(StructuredEditTransportImportError {
            category: StructuredEditTransportImportErrorCategory::UnsupportedVersion,
            message: format!(
                "unsupported structured_edit_provider_batch_execution_receipt_replay_workflow_apply_decision_outcome envelope version {}.",
                envelope.version
            ),
        });
    }

    Ok(envelope.batch_receipt_replay_workflow_apply_decision_outcome.clone())
}
